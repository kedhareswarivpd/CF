...
export default function PartnersStrip() {
  ...
  return (
    <section className="border-y border-outline-variant bg-surface-container px-margin-mobile py-stack-lg dark:border-dark-outline-variant dark:bg-dark-surface-container md:px-margin-desktop">
