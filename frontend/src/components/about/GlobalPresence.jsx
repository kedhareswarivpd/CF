    ...
    <section className="py-section-padding bg-brand text-white relative overflow-hidden">
      ...
      <div className="relative z-10 px-margin-mobile md:px-margin-desktop max-w-container mx-auto">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <Reveal from="right" className="relative h-[400px] md:h-[500px] bg-white/5 rounded-xl border border-white/10 flex items-center justify-center">
            <div className="text-center p-8">
              <Icon name="language" className="text-6xl text-accent-cyan mb-4 animate-float" />
