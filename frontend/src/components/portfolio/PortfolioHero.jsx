    ...
    <section className="relative bg-brand py-stack-xl px-margin-mobile md:px-margin-desktop overflow-hidden">
      <div className="relative z-10 max-w-container mx-auto grid md:grid-cols-2 gap-stack-lg items-center">
        <div className="flex flex-col gap-stack-md">
          <span className="font-label-caps text-label-caps uppercase text-accent-cyan">Project Portfolio</span>
          <h1 className="font-display text-headline-lg-mobile md:text-headline-lg text-white">
            Success Delivered: 430+ Projects Globally
          </h1>
          <p className="font-body text-body-lg text-surface-dim max-w-xl opacity-90">
        ...
        <div className="hidden md:flex justify-end">
          <div className="glass-panel p-8 rounded-lg w-full max-w-md">
            ...
            <div className="space-y-4">
              ...
              <div className="h-2 w-full bg-white/10 rounded-full overflow-hidden">
                <div className="h-full bg-accent-cyan/70 w-1/2" />
              </div>
              <div className="flex justify-between font-label-caps text-label-caps uppercase text-surface-dim">
