...
export default function Footer() {
  ...
  return (
    <footer className="relative w-full bg-white px-margin-mobile pb-stack-lg text-ink dark:bg-dark-surface dark:text-dark-ink md:px-margin-desktop">
      ...
      <div className="mx-auto grid max-w-container grid-cols-2 gap-x-8 gap-y-12 md:grid-cols-3 lg:grid-cols-6">
        ...
        <div className="col-span-2">
          <span className="mb-6 block font-display text-headline-sm text-brand-dark dark:text-dark-brand">CoreFusion</span>
          <p className="mb-8 max-w-xs font-body text-body-sm leading-relaxed text-ink-muted dark:text-dark-ink-muted">
      ...
      <div className="mx-auto mt-12 flex max-w-container flex-col items-center justify-between gap-6 border-t border-ink/10 pb-4 pt-10 dark:border-dark-ink/10 md:flex-row">
        ...
        <div className="flex gap-8 font-label-caps text-label-caps uppercase tracking-widest text-ink-muted dark:text-dark-ink-muted">
