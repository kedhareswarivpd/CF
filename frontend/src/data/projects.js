export const featuredCaseStudy = {
  slug: 'global-ledger-banking-infrastructure',
  tagPrimary: 'CASE STUDY',
  tagSecondary: 'FINTECH TRANSFORM',
  title: 'Global Ledger: Rethinking Banking Infrastructure',
  description:
    'Implementing a scalable, cloud-native ERP solution for a Fortune 500 financial entity, reducing transaction latency by 45% across three continents.',
  image:
    'https://lh3.googleusercontent.com/aida-public/AB6AXuC60cZcdU641EYjXo8aXd6XhhadkTMnhlz1qU6cC1YdSoEQMfclFWandIJqOUhbguzvIQ20NMRuEh_Zdi5j0jfSf9Wt5Ey5HZap2CnpUs2VECYw-ZGroW1xyIdL1dhEuTEVz4UpDJV9K0SmTAlJYvlUPi00UywCSeEFFoYT5bXXemEgOYjYl73QTOIK3Mwp-fFHJl9Vxq83nUclaHHV82hO33_L3GrfrUu_975yWW051p0y89_PAfo8',
  stats: [
    { label: 'IMPACT', value: '45% Faster' },
    { label: 'SECURITY', value: 'ISO 27001' },
  ],
};

export const successStories = {
  'global-ledger-banking-infrastructure': {
    tagPrimary: 'CASE STUDY',
    tagSecondary: 'FINTECH TRANSFORM',
    title: 'Global Ledger: Rethinking Banking Infrastructure',
    client: 'Fortune 500 Financial Entity',
    industry: 'Finance',
    duration: '18 Months',
    image:
      'https://lh3.googleusercontent.com/aida-public/AB6AXuC60cZcdU641EYjXo8aXd6XhhadkTMnhlz1qU6cC1YdSoEQMfclFWandIJqOUhbguzvIQ20NMRuEh_Zdi5j0jfSf9Wt5Ey5HZap2CnpUs2VECYw-ZGroW1xyIdL1dhEuTEVz4UpDJV9K0SmTAlJYvlUPi00UywCSeEFFoYT5bXXemEgOYjYl73QTOIK3Mwp-fFHJl9Vxq83nUclaHHV82hO33_L3GrfrUu_975yWW051p0y89_PAfo8',
    overview:
      'Implementing a scalable, cloud-native ERP solution for a Fortune 500 financial entity, reducing transaction latency by 45% across three continents.',
    challenge:
      'The client operated on a fragmented legacy banking infrastructure spanning 3 continents with 12 disparate systems that could not communicate in real time. Peak transaction failures reached 8% during high-load periods, and regulatory compliance audits were consuming 2,000+ man-hours annually.',
    solution:
      'CoreFusion designed and deployed a unified cloud-native ERP platform on AWS, integrating all regional systems through a single event-driven microservices backbone. A custom ISO 27001-compliant security layer was built to satisfy cross-border regulatory requirements simultaneously.',
    results: [
      { label: 'Transaction Latency', value: '45% Faster' },
      { label: 'Security Standard', value: 'ISO 27001' },
      { label: 'System Uptime', value: '99.98%' },
      { label: 'Compliance Hours Saved', value: '1,800 / yr' },
    ],
    techStack: ['AWS', 'Kubernetes', 'Kafka', 'PostgreSQL', 'React', 'Python'],
    testimonial: {
      quote:
        'CoreFusion delivered a transformation that our internal teams said was impossible in under two years. The platform is rock-solid and our compliance burden has dropped dramatically.',
      author: 'Chief Technology Officer',
      company: 'Fortune 500 Financial Entity',
    },
  },
};
...
export const globalNodes = [
  { top: '35%', left: '15%', label: 'Seattle, US' },
  { top: '60%', left: '32%', label: 'Sao Paulo, BR' },
  { top: '30%', left: '48%', label: 'London, UK' },
  { top: '45%', left: '55%', label: 'Dubai, UAE' },
  { top: '50%', left: '65%', label: 'Delhi, IN' },
  { top: '55%', left: '70%', label: 'Bangalore, IN' },
  { top: '35%', left: '85%', label: 'Tokyo, JP' },
  { top: '70%', left: '88%', label: 'Sydney, AU' },
];
