  ...
  return (
    <section className="max-w-container mx-auto px-margin-mobile md:px-margin-desktop py-section-padding">
      ...
      <div className="grid lg:grid-cols-12 gap-gutter">
        <div className="lg:col-span-7 bg-white dark:bg-dark-surface border border-outline-variant dark:border-dark-outline-variant rounded-lg p-stack-lg shadow-card">
          <ContactForm />
        </div>

        <div className="lg:col-span-5 flex flex-col gap-stack-lg">
          <div className="bg-brand-dark text-white rounded-lg p-stack-lg">
          ...
          <div className="bg-surface-low dark:bg-dark-surface-low border border-outline-variant dark:border-dark-outline-variant rounded-lg p-stack-lg">
